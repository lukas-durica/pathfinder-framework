...
class_name GraphBasedUITransition
...
func run():
	...
	$Graph/Paths/ConnectablePath/RemotePathFollow.set_remote_node($Agents/AgentGraph)
	$Agents/AgentGraph.path_follow = $Graph/Paths/ConnectablePath/RemotePathFollow
